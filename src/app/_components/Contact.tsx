      ...
      <div className="justify-center items-center flex flex-col gap-8 md:gap-14 py-16 md:py-28">
        ...
        <div className="text-center">
          ...
          <a href="mailto:oscarjoseph7991@gmail.co">
            <button className=" mt-6 md:mt-10 inline-flex items-center justify-center gap-3 md:gap-4  cursor-pointer bg-gradient-to-br from-[#088395] to-[#088395] dark:from-[#B31312] dark:to-[#BE3144] dark:hover:bg-[#BE3144] hover:bg-[#37B7C3] hover:bg-none  text-[#F3F3F3] py-2 px-5 md:py-3 md:px-6 md:text-[20px] font-bold italic text-sm ">
              Say hello
            </button>
          </a>
        </div>
